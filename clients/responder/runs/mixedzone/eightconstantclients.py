...
def main():
    ...
    try:
        ...
        zone_a_profile_paths = [
            'data/profiles/constant_rps_5_max_ia_1_duration_40_delay_0.pkl',
            'data/profiles/constant_rps_5_max_ia_1_duration_40_delay_0.pkl',
            'data/profiles/constant_rps_5_max_ia_1_duration_40_delay_0.pkl',
            'data/profiles/constant_rps_5_max_ia_1_duration_80_delay_30.pkl'
        ]

        zone_b_profile_paths = [
            'data/profiles/constant_rps_5_max_ia_1_duration_80_delay_30.pkl',
            'data/profiles/constant_rps_5_max_ia_1_duration_80_delay_30.pkl',
            'data/profiles/constant_rps_5_max_ia_1_duration_80_delay_40.pkl',
            'data/profiles/constant_rps_5_max_ia_1_duration_80_delay_45.pkl'
        ]
        ...
        clients_groups.append(
            spawn_client_group(zone_b_profile_paths, 'zone-b', duration, rds, galileo, distribution, cores))
        ...
        run(
            ...
            exp=exp,
            rds=rds,
            name=f'responder-mixedzone-eightsineclients-{int(time.time())}',
            params=params,
            requests=requests
        )
